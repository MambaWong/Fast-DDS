...
// TODO(MiguelCompany): Remove after we refactor the builtin topic structures
using ParticipantBuiltinTopicData = fastdds::dds::builtin::ParticipantBuiltinTopicData;
using PublicationBuiltinTopicData = fastdds::dds::builtin::PublicationBuiltinTopicData;
using SubscriptionBuiltinTopicData = fastdds::dds::builtin::SubscriptionBuiltinTopicData;
